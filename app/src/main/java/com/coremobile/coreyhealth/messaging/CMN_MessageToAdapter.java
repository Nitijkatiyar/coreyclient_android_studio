 ...
 *
 */
public class CMN_MessageToAdapter extends BaseAdapter {

	private ArrayList<CMN_MessageToModel> items;
	private LayoutInflater inflater;
	Activity context;
	HashMap<Integer, Boolean> isSelected;

	public CMN_MessageToAdapter(Activity context,
								ArrayList<CMN_MessageToModel> strings) {
	...
	public View getView(final int position, View convertView, ViewGroup arg2) {
		final CMN_MessageToModel item = items.get(position);
		...
		frequency.setText(item.getName());

		return myview;
	}

	public ArrayList<CMN_MessageToModel> getData() {
		ArrayList<CMN_MessageToModel> data = new ArrayList<CMN_MessageToModel>();
