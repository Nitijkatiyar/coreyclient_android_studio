 ...
 */
public class CMN_SendCoreyMessagesWebService extends
        AsyncTask<String, String, JSONObject> {
    ProgressDialog dialog;
    Activity activity;
    private String TAG = "Corey_SendCoreyMessages";

    public CMN_SendCoreyMessagesWebService(Activity activity) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        url = MessageTabActivityCMN.CMN_SERVER_BASE_URL_DEFINE
                + "SendCoreyMessage.aspx?token=" + CMN_Preferences.getUserToken(activity);
        Log.d(TAG, "url" + url);
