...
public class LookupByAnonymizedPatientId extends BaseActivityCMN implements NetworkCallBack, AsyncTaskCompleteListener<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lookup_by_anonymized_patient_id);
        ActivityPackage.setActivityList(this);

        getActionBar().setHomeButtonEnabled(true);
        getActionBar().setTitle("Search by Anonymized patient id");
        getActionBar().setDisplayHomeAsUpEnabled(true);


        _anonymId = (EditText) findViewById(R.id.anonymId);
        ...
        _search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    networkAsyncTask.startNetworkCall(ThreadTaskIds.GET_LOOKUP_DATA, LookupByAnonymizedPatientId.this);
        ...
        progressDialog = new ProgressDialog(LookupByAnonymizedPatientId.this);
    ...
    public Object onNetworkCall(int taskId, Object o) throws
        ...
        if (taskId == ThreadTaskIds.GET_LOOKUP_DATA) {
            String url = CMN_Preferences.getBaseUrl(LookupByAnonymizedPatientId.this)
                    + "PatientLookup_s.aspx?token=" + CMN_Preferences.getUserToken(LookupByAnonymizedPatientId.this);

            NetworkTools networkTools = NetworkTools.getInstance();
            if (networkTools.checkNetworkConnection(LookupByAnonymizedPatientId.this) && url.length() > 0) {
                JSONObject response = networkTools.postJsonData(LookupByAnonymizedPatientId.this, url, generateJson());
                try {
                    if (response != null) {
                ...
                Toast.makeText(LookupByAnonymizedPatientId.this, CMN_ErrorMessages.getInstance().getValue(12), Toast.LENGTH_SHORT).show();
            }
        }
            ...
            if (response.getJSONObject("Result").getInt("Code") == 0) {
                ...
                if (messagesArray.length() == 0) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(LookupByAnonymizedPatientId.this, "No patient found for the given Name.", Toast.LENGTH_SHORT).show();
                        }
                    });
                    return;
                }
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(isSearchPatient) {
                            ...
                            ArrayAdapter _adapter = new ArrayAdapter<String>(LookupByAnonymizedPatientId.this,
                        ...
                        _patient.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                ...
                                if (Utils.viewSchedule) {
                                    Intent intent = new Intent(LookupByAnonymizedPatientId.this, CMN_GenericViewActivity.class);
                                    intent.putExtra("scheduling", "" + ViewScheduleActivity.jsonObject);
                                    CMN_Preferences.setScheduleContextId(LookupByAnonymizedPatientId.this, lookupModels.get(_patient.getSelectedItemPosition()).getID());
                                    startActivity(intent);
                                } else {
                                    Intent intent = new Intent(LookupByAnonymizedPatientId.this, CalenderActivity.class);
                                    CMN_Preferences.setScheduleContextId(LookupByAnonymizedPatientId.this, lookupModels.get(_patient.getSelectedItemPosition()).getID());
                                    startActivity(intent);
                                }
    ...
    public JSONObject generateJson() {
        ...
        try {
            jsonObject.put("AnonId", "" + _anonymId.getText().toString().trim());
        } catch (JSONException e) {
            e.getMessage();
        }
    ...
    private void showAlert(String message) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(LookupByAnonymizedPatientId.this, android.R.style.Theme_Dialog));
