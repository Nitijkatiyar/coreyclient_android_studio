 ...
 */
public class MaterialCalendarS {
    // Variables
    ...
    private static void refreshCalendar(TextView monthTextView, GridView calendarGridView,
      ...
      /*  if (com.coremobile.coreyhealth.scheduling.schedulingcalender.MaterialCalendarFragmentS.mSavedEventsAdapter != null) {
            com.coremobile.coreyhealth.scheduling.schedulingcalender.MaterialCalendarFragmentS.mNumEventsOnDay = -1;
            com.coremobile.coreyhealth.scheduling.schedulingcalender.MaterialCalendarFragmentS.mSavedEventsAdapter.notifyDataSetChanged();
            Log.d("EVENTS_ADAPTER", "refresh");
        }*/


        MaterialCalendarFragmentS.refreshData(month);
...
//            materialCalendarAdapter.notifyDataSetChanged();
    ...
    protected static String selectCalendarDay(MaterialCalendarAdapter materialCalendarAdapter, int position) {
        ...
        if (position > noneSelectablePositions) {
            ...
            return getSelectedDate(position, mMonth, mYear);

        }
        return "";
    }

    private static String getSelectedDate(int selectedPosition, int month, int year) {
        int weekPositions = 6;
        int dateNumber = selectedPosition - weekPositions - mFirstDay;
        Log.d("DATE_NUMBER", String.valueOf(dateNumber));
        month = month+1;
        String dayName = ""+dateNumber;
        if(dateNumber<10){
            dayName = "0"+dayName;
        }
        ...
        return String.valueOf(year + "-" + monthName + "-" + dayName);
    }
}
