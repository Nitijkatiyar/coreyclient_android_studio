 ...
 */
public class RefreshPatientListWebService extends
        AsyncTask<String, String, JSONObject> {
    ProgressDialog dialog;
    MessageTabActivityCMN activity;
    private String TAG = "Corey_GetAllContext";

    public static HashMap<String, MessageItem> patientsContextsMap;
    NavDrawerManager mNavDrawerManager;

    public RefreshPatientListWebService(MessageTabActivityCMN activity, NavDrawerManager mNavDrawerManager) {
    ...
    protected void onPreExecute() {
        ...
        dialog.show();
        GetAllContextWebService.patientsContexts = new ArrayList<MessageItem>();
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        String url = CMN_Preferences.getBaseUrl(activity)
        ...
        try {
            ...
            if (json.getJSONObject("Result").getInt("Code") == 0) {
                ...
                for (int i = 0; i < messagesArray.length(); i++) {
                    ...
                    GetAllContextWebService.patientsContexts.add(patientContext);

                    patientsContextsMap.put(jsonObject.getString("DisplayName"), patientContext);
    ...
    protected void onPostExecute(JSONObject result) {
        ...
        if (dialog.isShowing()) {
            ...
            activity.getSinglePatientData(activity, GetAllContextWebService.patientsContexts.get(0).ContextId);
        }
    }
}
