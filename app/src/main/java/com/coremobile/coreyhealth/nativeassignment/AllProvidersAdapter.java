 ...
 */
public class AllProvidersAdapter extends BaseAdapter {

    private ArrayList<AllProvidersModel> items;
    private LayoutInflater inflater;
    Activity context;
    HashMap<Integer, Boolean> isSelected;

    public AllProvidersAdapter(Activity context,
                               ArrayList<AllProvidersModel> strings) {
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        final AllProvidersModel item = items.get(position);
        ...
        frequency.setText(item.getProviderName());

        return myview;
    }

    public ArrayList<AllProvidersModel> getData() {
        ArrayList<AllProvidersModel> data = new ArrayList<AllProvidersModel>();
