package com.coremobile.coreyhealth.uninvite_reinvite;
...
public class CMN_PatientDisplayActivity extends CMN_AppBaseActivity implements AsyncTaskCompleteListener<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(CMN_PatientDisplayActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                ...
                deactivate_reactivate_patient_url = CMN_Preferences.getBaseUrl(CMN_PatientDisplayActivity.this)
                        + "DeactivateReactivatePatient.aspx?token=" + CMN_Preferences.getUserToken(CMN_PatientDisplayActivity.this) + "&deactivate=" + getIntent().getExtras().getBoolean("radio");

                NetworkTools networkTools = NetworkTools.getInstance();
                if (networkTools.checkNetworkConnection(CMN_PatientDisplayActivity.this) && deactivate_reactivate_patient_url.length() > 0) {

                    asyncTaskCompleteListener = CMN_PatientDisplayActivity.this;
                    ...
                    Toast.makeText(CMN_PatientDisplayActivity.this, CMN_ErrorMessages.getInstance().getValue(12), Toast.LENGTH_SHORT).show();
    ...
    private void showAlert(String message) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(CMN_PatientDisplayActivity.this, android.R.style.Theme_Dialog));
