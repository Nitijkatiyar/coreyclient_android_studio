package com.coremobile.coreyhealth.adapters;
...
import com.coremobile.coreyhealth.scheduling.LookupModel;

import java.util.ArrayList;

public class PatientInfoRowViewAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<LookupModel> objects;
    private String[] mKeys;
  public  SparseBooleanArray mCheckStates;
    public PatientInfoRowViewAdapter(Context context, ArrayList<LookupModel> objects) {
...
*/
        ...
        holder.checkBox.setChecked(getItem(position).getSelected());
